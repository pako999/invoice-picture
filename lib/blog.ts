...
export const posts: BlogPost[] = [
  ...
  },
  {
    ...
    keyword: "aplikacija za skeniranje računov, OCR računov, skeniranje računov",
    title: "Aplikacija za skeniranje računov + OCR: vodič 2026",
    description: "Aplikacija za skeniranje računov v Sloveniji: primerjava scannerjev in OCR rešitev. Preberite, kdaj potrebujete PDF, OCR podatke, UBL/eSLOG ali povezavo z računovodstvom.",
    readingMinutes: 10,
    excerpt: "Scanner ali pravi OCR računov? Primerjamo mobilno skeniranje, ekstrakcijo podatkov, validacijo in povezavo z računovodskim programom.",
    coverAlt: "Aplikacija za skeniranje in OCR računov na pametnem telefonu",
    slugEn: "best-invoice-scanner-apps-slovenia",
    keywordEn: "invoice scanner app Slovenia, invoice OCR Slovenia",
    titleEn: "Invoice Scanner App in Slovenia: OCR vs Scanning (2026)",
    descriptionEn: "Need an invoice scanner app in Slovenia? Compare simple scanning with invoice OCR, data extraction, validation and accounting integrations for Slovenian businesses.",
    readingMinutesEn: 10,
    excerptEn: "Scanner app or invoice OCR? Compare PDF capture, data extraction, validation and accounting-system delivery in Slovenia.",
    coverAltEn: "Invoice scanner and OCR app on a smartphone in Slovenia",
  },
];
